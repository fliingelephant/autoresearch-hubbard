...
3. **Read the in-scope files**:
   ...
   - `prepare.py` — fixed constants (`TRIAL_SECONDS`, lattice, U, t), Hamiltonian builder, ED helpers. Do not modify.
...
4. **Initialize `results.tsv`**: create with only the header row (see below). The baseline is recorded after the first run.
5. **Confirm and go**.
